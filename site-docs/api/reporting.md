...
`decision`, `session_start`, `session_risk_change`, `alert`, `session_enforcement_change`, `defer_pending`, `defer_resolved`, `post_action_finding`, `trajectory_alert`, `pattern_candidate`, `pattern_evolved`
